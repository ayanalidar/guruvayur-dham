...
export default function RoomsPage() {
  ...
  const subtitle = get("rooms.subtitle", "From ₹1,500/night Deluxe rooms to ₹3,500 family suites · every option is sanitised daily, comes with 24×7 hot water and free WiFi, and is a 2-minute walk from temple gate.");
