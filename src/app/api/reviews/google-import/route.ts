...
const DEMO_REVIEWS = [
  ...
  },
  {
    ...
    rating: 5,
    text: "The best decision we made for our Guruvayur trip! Booked the Deluxe AC room and it was pristine · fresh linen, working AC, great shower pressure. The staff helped us book prasadam and Pushpanjali without any queue. Walk to the temple in 2 minutes. Highly recommend!",
  ...
  },
  {
    ...
    rating: 5,
    text: "As a frequent visitor to Mathura, I've stayed at many places near the temple. Guruvayur Dham stands out for its cleanliness, warm staff, and genuine pilgrim-friendly approach. The 24×7 hot water and free parking are huge pluses. Manager Krishna Sharma personally ensures every guest is comfortable.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Family of 6 stayed in the Superior Room for 3 nights during Janmashtami. Spacious, clean, and the kitchenette was handy for making morning coffee before darshan. Staff arranged midnight abhishekam darshan at Krishna Janmabhoomi · unforgettable experience. Thank you Guruvayur Dham!",
